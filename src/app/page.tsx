...
export default function Home() {
  ...
  return (
    <main className="h-screen bg-zinc-50 dark:bg-black overflow-hidden flex flex-col">
      <div className="container mx-auto px-0 lg:px-4 flex-1 flex flex-col pt-0 lg:pt-6 pb-0 lg:pb-4 min-h-0">
        <div className={cn(
          "transition-all duration-700 ease-in-out flex flex-col justify-center flex-shrink-0",
          isCompact ? "min-h-[32px] h-8 mb-0 lg:min-h-12 lg:mb-4 lg:h-auto" : "min-h-[140px] mb-6 lg:mb-10"
        )}>
          <div className={cn(
            "flex flex-col justify-between gap-2 lg:gap-6 max-w-6xl mx-auto w-full transition-all duration-700",
            isCompact ? "flex-row items-center px-4 lg:text-left" : "text-center px-4"
          )}>
            <div className="transition-all duration-700">
              <h1 className={cn(
                "font-black tracking-tighter text-zinc-900 dark:text-zinc-50 transition-all duration-700",
                isCompact ? "text-lg lg:text-3xl" : "text-4xl sm:text-7xl mb-2 lg:mb-4"
              )}>
            ...
            <div className={cn(
              ...
              isCompact ? "hidden lg:flex" : "scale-100 lg:scale-105"
            )}>
              <div className={cn(
                "bg-zinc-100 dark:bg-zinc-900/50 px-3 lg:px-4 py-2 lg:py-2.5 rounded-lg lg:rounded-xl border border-zinc-200 dark:border-zinc-800 text-[10px] lg:text-xs text-zinc-600 dark:text-zinc-400"
              )}>
              ...
              <div className={cn(
                "bg-amber-50 dark:bg-amber-950/20 px-3 lg:px-4 py-2 lg:py-2.5 rounded-lg lg:rounded-xl border border-amber-100 dark:border-amber-900/50 text-[10px] lg:text-xs text-amber-800/80 dark:text-amber-200/60"
              )}>
        ...
        <div className="bg-white dark:bg-zinc-900 shadow-xl lg:rounded-2xl overflow-hidden border-t lg:border border-zinc-200 dark:border-zinc-800 flex-1 min-h-0">
